...
urlpatterns = [
    ...
    url(r'brews.json$', views.brew_list_page, name='brew-list-json'),
    ...
    url(r'^bags/(\d+)/edit/?$', views.edit_coffee_bag, name='bag-edit'),
    url(r'^bags/(\d+)/copy/?$', views.copy_coffee_bag, name='bag-copy'),
